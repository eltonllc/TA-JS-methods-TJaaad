...
*/
function addTwoToArray(arr = [1, 2, 3, 4, 5]) {
  let finalArr = [];
  for (let i of arr) {
...
*/
function addThreeToArray(arr = [1, 2, 3, 4, 5]) {
  let finalArr = [];
  for (let i of arr) {
...
/*
  Create a function named addFiveToArray which accepts:
    ...
    - while doing so use the funciton addThree
*/
function addFiveToArray(arr = [1, 2, 3, 4, 5]) {
  let finalArr = [];
  for (let i of arr) {
...
function changeArray(arr = [1, 2, 3, 4, 5], cb) {
  let finalArr = [];
  for (let i of arr) {
    finalArr.push(cb(i));
  }
...
changeArray([1, 2, 3, 4, 5, 6], addTwo);
changeArray([1, 2, 3, 4, 5, 6], addThree);
changeArray([1, 2, 3, 4, 5, 6], addFive);
...
*/
function sendMessage(message="hello", cb) {
  return cb(message);
}
sendMessage("Hello", console.log);
sendMessage("Hello Alert!", alert);
